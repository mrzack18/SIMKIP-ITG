...
export default function PeriodeAktifCard({
    ...
    return (
      <div className="rounded-xl border-2 border-dashed border-gray-200 p-6 text-center bg-gray-50/50">
        ...
        <button
          ...
          className="px-4 py-2 text-xs font-500 text-white rounded-lg"
  ...
  return (
    <div className="rounded-xl border-2 border-green-200 bg-gradient-to-br from-green-50 to-white p-5 relative overflow-hidden">
        ...
        <div className="flex items-start justify-between mb-3">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className={`text-[10px] px-2 py-0.5 rounded-full font-600 ${statusPeriode.bg} ${statusPeriode.color}`}>
                {statusPeriode.label}
              </span>
            </div>
            <div className="text-xl font-display font-700 text-gray-900">
