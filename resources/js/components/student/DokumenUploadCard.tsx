...
export function DokumenUploadCard({
  ...
  return (
    <div
      className={`rounded-xl border p-4 transition-shadow hover:shadow-sm ${cfg.borderColor} ${cfg.bgColor}`}
    >
          ...
          <div className="flex items-start justify-between gap-2">
            <div>
              <div className="flex items-center gap-1.5">
                ...
                {dokumen.wajib && (
                  <span className="text-xs bg-[#263F93]/10 text-[#263F93] px-1.5 py-0.5 rounded-full font-500">
                    Wajib
                  </span>
                )}
              </div>
            ...
            <div className="ml-auto flex items-center gap-2">
              {isNotUploaded && onUpload && (
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg bg-[#263F93] text-white hover:bg-[#1B2F73] transition-colors font-500"
                >
                  <Upload size={11} />
                  Unggah
                </button>
              ...
              {isDenied && onReupload && (
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg border border-[#263F93] text-[#263F93] hover:bg-[#263F93]/5 transition-colors font-500"
                >
                  <Upload size={11} />
                  Unggah Ulang
                </button>
