...
import { mahasiswaList, ipkHistory, spHistoryData, kendalaList } from "@/data/mockData"
...
const mockPrestasi = [
  {
    ...
    pencapaian: "Best Paper Award",
    penyelenggara: "IEEE Indonesia",
    tanggalMulai: "12 Mar 2026",
    tanggalSelesai: "14 Mar 2026",
    tempat: "Jakarta",
    deskripsi:
      "Kompetisi paper internasional yang diselenggarakan oleh IEEE Indonesia, diikuti peserta dari 15 negara.",
  ...
  },
  {
    ...
    tanggalMulai: "5 Jan 2026",
    tanggalSelesai: "7 Jan 2026",
    tempat: "Bandung",
    deskripsi:
      "Hackathon tingkat nasional yang diselenggarakan oleh Kemendikbud dengan tema Smart City.",
...
const mockPelatihanAkademik = [
  {
    ...
    tempat: "Garut",
    deskripsi:
      "Pelatihan pengenalan machine learning menggunakan Python dan TensorFlow.",
    status: "Disetujui" as const,
  },
  {
    id: 2,
    nama: "Workshop Data Science",
    penyelenggara: "ITG & BPPT",
    tanggalMulai: "5 Juli 2026",
    tanggalSelesai: "6 Juli 2026",
    tempat: "Bandung",
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <div className="space-y-3">
          {kendalaList.map((kendala) => (
            <div key={kendala.id} className="p-3 bg-white border border-[#E2E8F0] rounded-xl text-sm">
              <div className="flex items-center justify-between mb-1">
                <span className="font-semibold text-gray-800">{kendala.kategori} - {kendala.tahunAjaran}</span>
                <span className="text-xs text-gray-500">{kendala.tanggal}</span>
              </div>
              <p className="text-gray-600">{kendala.deskripsi}</p>
            </div>
          ))}
        </div>
            ...
            >
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <select className="w-full px-3 py-2 border border-[#E2E8F0] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#263F93]/20">
              ...
              <div className="pt-2 flex justify-end gap-2 border-t border-[#E2E8F0]">
                <button
                  onClick={() => setCatatan("")}
                  className="px-4 py-2 text-sm font-medium border border-gray-200 text-gray-600 rounded-xl hover:bg-gray-50"
                >
                  Batal
                </button>
                <button
